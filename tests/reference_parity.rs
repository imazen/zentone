// `reinhard_extended` is publicly deprecated as of the 2026-06-22 audited HDR→SDR
// shootout (superseded by `Bt2446A`). This reference-parity test still calls
// through it because it pins the libultrahdr `ReinhardMap` golden output.
#![allow(deprecated)]
